...
//ulozky na doma - Mnozstevni sleva
...
//Ulozky na doma - neide mi to !!!
/*const Number = Number.prompt('Zadejte cislo od 0-36:');
const sudaCisla = number % 2 === 0;
const licheCisla = number % 2 !== 0;


if (sudaCisla >= 0 && sudaCisla >= 28 ) {
    document.body.innerHTML += '<p>Cerne cislo</p>';
} else if (licheCisla >= 0 && licheCisla >= 28) {
    document.body.innerHTML += '<p>Cervene cislo</p>';
} else if (sudaCisla >= 29 && sudaCisla <= 36) {
    document.body.innerHTML += '<p>Cervene cislo</p>';
} else if (licheCisla >= 29 && licheCisla <= 36) {
    document.body.innerHTML += '<p>Cerne cislo</p>';
} else {
    document.body.innerHTML += '<p>Neplatne cislo</p>';
}*/
